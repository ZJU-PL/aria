...
import aria.itp.reflect as reflect
...
class Hoare:
    ...
    It is analogous to a aria.itp.Proof object in this sense.
    ...
    def ite(cls, cmd: ast.If, hoare_body: "Hoare", hoare_orelse: "Hoare"):
        ...
        match cmd:
            case ast.If(test=test, body=body, orelse=orelse):
                ...
                p1 = itp.prove(smt.Implies(hoare_body.pre, test))
                p2 = itp.prove(smt.Implies(hoare_orelse.pre, smt.Not(test)))
                return Hoare(
    ...
    def strengthen_pre(self, P1: smt.BoolRef, by=[]) -> "Hoare":
        ...
        pf = itp.prove(smt.Implies(P1, self.pre), by=by)
        return Hoare(
    ...
    def weaken_post(self, Q1: smt.BoolRef, by=[]) -> "Hoare":
        ...
        pf = itp.prove(smt.Implies(self.post, Q1), by=by)
