...
import shutil
import aria.itp.solvers.gappa as gappa
import aria.itp.solvers.aprove
import aria.itp.solvers.kb as kb
import aria.itp.rewrite as rw

# Check availability of optional dependencies
EGGSOLVER_AVAILABLE = True
try:
    from aria.itp.solvers.egglog import EgglogSolver
except ImportError:
...
def test_huet():
    ...
    # With and without caching in aria.itp.smt makes a big difference
...
def test_lean():
    ...
    # Inductive Datatypes
    #from aria.itp.theories.nat import Nat
