...
def parse_options():
    ...
    try:
        opts, args = getopt.getopt(
            sys.argv[1:], "hs:c:v", ["help", "solver=", "cardenc=", "verbose"]
        )
    ...
    if (
        ...
        or solver in SolverNames.gluecard3
        ...
        assert (
            cardenc != encmap["native"]
        ), "Only Minicard can handle cardinality constraints natively"
