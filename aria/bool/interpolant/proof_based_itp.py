...
The problem is, how to extract the resolution proof, e.g., from Z3, pysat,
pySMT, or CVC5?. Or, should we use the a resolution-based proof system by
ourself (which can be slow)?
"""
