...
This module implements the SYMBA algorithm from the paper
"Symbolic Optimization with SMT Solvers, POPL 2014"
for optimizing objective functions in linear real arithmetic using
