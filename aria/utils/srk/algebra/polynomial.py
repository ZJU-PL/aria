...
Example:
    >>> from aria.utils.srk.algebra.polynomial import Polynomial, MonomialOrder
...
import heapq
from ..core.syntax import mk_real, ArithExpression, Context
        ...
        for i, exp in enumerate(mon.exponents):
            if exp > 0:
                ...
                if exp == 1:
                    ...
                    from ..core.syntax import mk_pow
                    parts.append(mk_pow(srk, t, exp))
        if not parts:
            return mk_real(srk, Fraction(1))
        if len(parts) == 1:
            return parts[0]
        from ..core.syntax import mk_mul
...
class Polynomial:
    ...
    def term_of(srk, ctx_of_int, poly: "Polynomial"):
        ...
        from ..core.syntax import mk_var, Type
...
def qq_term_of(srk: Any, term: ArithExpression, poly: "UnivariatePolynomial") -> ArithExpression:
    ...
    """
    from aria.utils.srk.core.syntax import mk_add, mk_mul, mk_real, mk_pow, mk_const
    from aria.utils.srk.linalg.linear import linterm_of
