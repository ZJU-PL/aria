...
from aria.utils.srk.linalg.qQ import QQ, equal as QQ_equal
from aria.utils.srk.misc.log import logf
...
class NonlinearOperations:
                ...
                if hasattr(power_symbol, "name") and power_symbol.name.startswith(
                    ...
                    try:
                        ...
                        if power_int is not None:
                            ...
                            from ..core.syntax import mk_pow as syntax_mk_pow
    ...
    def linearize(self, formula: FormulaExpression) -> FormulaExpression:
        ...
        try:
            from ..logic.quantifier import _contains_quantifier
