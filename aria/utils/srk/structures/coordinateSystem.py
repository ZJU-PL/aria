...
class CoordinateSystem:
    ...
    def _vec_of_term_recursive(self, term: Expression, admit: bool) -> QQVector:
        ...
        from ..core.syntax import Const, Var, App, Add, Mul
...
def term_of_polynomial(cs: CoordinateSystem, poly: "Polynomial") -> ArithExpression:
    ...
    """
    from aria.utils.srk.core.syntax import mk_add, mk_mul, mk_real
...
def project_ideal(
    ...
    """
    from aria.utils.srk.core.syntax import mk_eq, mk_or, mk_true, mk_const
    ...
    for poly in generators:
        ...
        if not remaining_terms:
            ...
            from aria.utils.srk.algebra.polynomial import Polynomial as Poly
