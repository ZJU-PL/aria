...
from aria.utils.srk.core.syntax import Context, Symbol, Type, Expression, make_expression_builder
...
def vanishing_space(
    ...
    from ..linalg.linear import QQVector, QQMatrix, solve as linear_solve
    ...
    while dim >= 0:
        ...
        from ..linalg.linear import term_of_vec
