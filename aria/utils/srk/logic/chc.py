...
import logging
from ..core.syntax import Context
...
def mk_rel_atom(srk: Any, fp: Fp, rel: Relation, syms: List[Any]) -> RelAtom:
    ...
    """
    from ..core.syntax import typ_symbol
...
def to_weighted_graph(srk: Any, fp: Fp, pd: Any) -> Any:
    ...
    Returns:
        Weighted graph
    """
    from ..structures.weightedGraph import WeightedGraph, add_vertex, add_edge, path_weight
    from ..lts.transitionFormula import make as make_tf
    ...
    def mul_weights(w1, w2):
        ...
        from ..lts.transitionFormula import mul as tf_mul
    ...
    def star_weight(weight):
        ...
        # Create loop counter
        from ..core.syntax import mk_symbol
...
def check(srk: Any, fp: Fp, pd: Any) -> str:
    ...
    from ..structures.weightedGraph import path_weight
