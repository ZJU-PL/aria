...
from ..linalg.linear import QQVector, QQMatrix
from ..lts import transitionFormula as TF
from ..logic import smt as Smt
...
class WedgeGuard:
    ...
    def abstract(self, srk: Context, tf: Any) -> WedgeGuardElement:
        ...
        try:
            from ..analysis.wedge import wedge_hull
    ...
    def abstract_wedge(
        ...
        """Abstract a wedge element to this domain."""
        from ..lts.transitionFormula import post_symbols as tf_post, pre_symbols as tf_pre
    ...
    def exp(
        ...
        """
        from ..lts.transitionFormula import identity, formula as tf_formula
...
class PolyhedronGuard:
    ...
    def abstract(self, srk: Context, tf: Any) -> PolyhedronGuardElement:
        ...
        from ..linalg.polyhedron import abstract as poly_abstract
    ...
    def join(
        ...
        from ..linalg.polyhedron import union as poly_union
    ...
    def closure(self, elem: PolyhedronGuardElement) -> FormulaExpression:
        ...
        from ..linalg.polyhedron import closure as poly_closure
    ...
    def widen(
        ...
        from ..linalg.polyhedron import widen as poly_widen
    ...
    def exp(self, srk: Context, elem: PolyhedronGuardElement, tr_symbols: List[Tuple[Symbol, Symbol]], loop_count: Any) -> FormulaExpression:
        ...
        from ..linalg.polyhedron import to_formula as poly_to_formula
    ...
    def precondition(self, elem: PolyhedronGuardElement) -> FormulaExpression:
        ...
        from ..lts.transitionFormula import pre_map
...
class LinearGuard:
    ...
    def abstract(self, srk: Context, tf: Any) -> LinearGuardElement:
        ...
        try:
            from ..lts.transitionFormula import formula as tf_formula, symbols as tf_symbols
            from ..lts.transitionFormula import (
                post_symbols as tf_post,
                pre_symbols as tf_pre,
            )
            from ..lts.transitionFormula import exists as tf_exists
            from ..algebra.nonlinear import linearize
            from ..logic.quantifier import mbp
    ...
    def widen(
        ...
        try:
            from ..logic.smt import equiv
            from ..logic.abstract import abstract as apron_abstract
            from ..misc.apron import formula_of_property, widen as apron_widen

            # Try Apron
            try:
                import aria.utils.srk.misc.apron as apron
...
class LossyTranslation:
    ...
    def abstract(self, srk: Context, tf: Any) -> LossyTranslationElement:
        ...
        try:
            ...
            from ..algebra.nonlinear import linearize
            from ..logic.abstract import abstract as apron_abstract
            from ..misc.apron import formula_of_property
            from ..linalg.linear import linterm_of, const_dim
...
class GuardedTranslation:
    ...
    def abstract(self, srk: Context, tf: Any) -> GuardedTranslationElement:
        ...
        """
        from ..logic.abstract import vanishing_space
        from ..logic import quantifier
...
class Split:
    ...
    def abstract(
        ...
        def collect_rr(expr: Expression) -> Expression:
            from ..logic.srkSimplify import simplify_terms
            if isinstance(expr, Not):
                ...
                # Atom(Arith(op, s, t))
                from ..core.syntax import Eq, Lt, Leq
        ...
        from ..algebra.nonlinear import uninterpret_rewriter
...
def phase_graph(
    ...
    """
    from ..structures.weightedGraph import WeightedGraph
...
def phase_mp(
    ...
    """
    from ..structures.weightedGraph import WeightedGraph, omega_path_weight
    from ..structures import weightedGraph as WG_module
...
def _abstract_delta_wedge(
    ...
    try:
        from ..analysis.wedge import is_bottom as wedge_is_bottom, to_atoms
        from ..linalg.linear import QQVector, const_dim
    except ImportError:
        return NRIElement([])
...
class MakeDomain:
    ...
    def abstract(self, srk: Context, tf: Any) -> IterationDomainElement:
        ...
        from ..lts.transitionFormula import symbols_of as tf_symbols
