...
from ..linalg import linear
from ..core import syntax
from ..logic import smt as Smt
from ..logic import interpretation
from ..logic import srkSimplify
from ..algebra import nonlinear
from ..misc import apron as ApronInterface
from ..structures import coordinateSystem as CS
from ..algebra import polynomial as P
from ..algebra.polynomial import RewriteSystem
from ..core.syntax import ArithExpression, Context, FormulaExpression
from ..linalg.linear import QQVector
from ..linalg.fourierMotzkin import eliminate as fm_eliminate
...
from aria.utils.srk.linalg.interval import Interval as _Interval
...
def _fm_eliminate_atoms(srk, atoms, var_ids):
    ...
    for atom in atoms:
        ...
        if op == "Atom":
            ...
            continue
        from ..linalg.linear import linterm_of, const_dim, sym_of_dim
        try:
...
class WedgeElement:
    ...
    def exists(self, variables):
        ...
        if not variables or not self.constraints:
            return self
        from ..core.syntax import symbols as get_symbols
...
def bounds(
    ...
    """
    from ..linalg.interval import Interval as _Int
