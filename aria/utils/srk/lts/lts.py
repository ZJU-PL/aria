...
from aria.utils.srk.core.syntax import Context, Symbol, Type, Expression
from aria.utils.srk.linalg.linear import QQVector, QQMatrix, QQVectorSpace, identity_matrix
...
def divide_right(A: QQMatrix, B: QQMatrix) -> Optional[QQMatrix]:
    ...
    try:
        from ..linalg.linear import divide_right as linear_divide_right
...
def divide_left(A: QQMatrix, B: QQMatrix) -> Optional[QQMatrix]:
    ...
    try:
        from ..linalg.linear import divide_left as linear_divide_left
...
def nullspace(matrix: QQMatrix, dims: List[int]) -> List[QQVector]:
    ...
    try:
        from ..linalg.linear_advanced import null_space
...
def linear_solve(matrix: QQMatrix, vector: QQVector) -> Optional[QQVector]:
    ...
    try:
        from ..linalg.linear_utils import solve_linear_system
...
class LTSAnalysis:
    ...
    def abstract_lts(self, tf: TransitionFormula) -> LinearTransitionSystem:
        ...
        try:
            ...
            from ..linalg.linear import Linear, linterm_of
...
def periodic_rational_spectrum_reflection(
    ...
    from ..linalg.linear import periodic_rational_spectral_decomposition
...
def rational_spectrum_reflection(
    ...
    from ..linalg.linear import rational_spectral_decomposition
