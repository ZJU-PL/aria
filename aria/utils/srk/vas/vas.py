...
from ..logic import abstract
from ..lts import transitionFormula as TF
from ..core import syntax
from ..logic import smt as Smt
from ..logic import interpretation  # Re-enabled - interpretation module is now complete
...
def mk_nat_leq(
    ...
    """
    from ..core.syntax import destruct as _destruct
