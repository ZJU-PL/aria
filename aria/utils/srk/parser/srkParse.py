...
# Import the lexer
from aria.utils.srk.parser.srkLex import tokens, make_lexer
from aria.utils.srk.core.srkAst import SimplifyingContext
...
from aria.utils.srk.core.syntax import mk_symbol, mk_const, mk_real, mk_add, mk_mul, mk_neg, mk_div
from aria.utils.srk.core.syntax import mk_eq, mk_leq, mk_lt, mk_geq, mk_and, mk_or, mk_not, mk_ite
from aria.utils.srk.core.syntax import mk_forall, mk_exists, mk_pow as _syntax_mk_pow
...
def mk_pow(base: ArithExpression, exponent: ArithExpression) -> ArithExpression:
    ...
    """
    from aria.utils.srk.core.syntax import Const, Type
