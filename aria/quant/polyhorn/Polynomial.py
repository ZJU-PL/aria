...
class Monomial:
    ...
    def __str__(self):
        ...
        return "*".join(
            ...
            + [
                str(self.variables[i]) + "^" + str(self.degrees[i])
    ...
    def __mul__(self, other):
        ...
        return Monomial(
            self.variables,
            np.array(self.degrees) + np.array(other.degrees),
    ...
    def __eq__(self, other) -> bool:
        ...
        for i in range(len(self.variables)):
            if (
                self.variables[i] != other.variables[i]
                or self.degrees[i] != other.degrees[i]
            ):
                return False
        return True
...
class Polynomial:
    ...
    def revise(self):
        ...
        while i < len(self.monomials):
            ...
            new_list.append(
                Monomial(
                    self.monomials[i].variables, self.monomials[i].degrees, coefficient
                )
            )
            i = j
    ...
    def add_variables(self, new_variables: List[UnknownVariable]):
        ...
        for monomial in self.monomials:
            monomials.append(
                Monomial(
                    monomial.variables + new_variables,
