...
import z3
from aria.quant.fossil.naturalproofs.utils import transform_expression
...
def cvc4_compliant_formula_sexpr(formula):
    ...
    member = z3.Function(
        "member", z3.IntSort(), z3.SetSort(z3.IntSort()), z3.BoolSort()
    )
    insert = z3.Function(
        "insert", z3.IntSort(), z3.SetSort(z3.IntSort()), z3.SetSort(z3.IntSort())
    )
