from aria.efmc.engines.polyhorn.Coefficient import Coefficient
...
class PolynomialConstraint:
    ...
    def convert_to_preorder(self) -> str:
        ...
        """
        return (
            "(" + self.sign + " " + self.polynomial.convert_to_preorder() + " " + "0)"
        )
...
class CoefficientConstraint:
    ...
    def convert_to_preorder(self) -> str:
        ...
        """
        return (
            "(" + self.sign + " " + self.coefficient.convert_to_preorder() + " " + "0)"
        )
    ...
    def is_equality(self) -> bool:
        ...
        if len(self.coefficient.elements) == 2:
            if (
                len(self.coefficient.elements[0].variables)
                + len(self.coefficient.elements[1].variables)
                == 1
            ):
                return True
            else:
