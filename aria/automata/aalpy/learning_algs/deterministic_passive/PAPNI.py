from aria.automata.aalpy.utils import is_balanced
from aria.automata.aalpy.automata.Vpa import vpa_from_dfa_representation
...
def run_PAPNI(data, vpa_alphabet, algorithm='edsm', print_info=True):
    ...
    """
    from aria.automata.aalpy.learning_algs import run_EDSM, run_RPNI
