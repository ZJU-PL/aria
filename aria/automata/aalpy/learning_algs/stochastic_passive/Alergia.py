...
from aria.automata.aalpy.automata import MarkovChain, MdpState, Mdp, McState, StochasticMealyState, \
    StochasticMealyMachine
from aria.automata.aalpy.learning_algs.stochastic_passive.CompatibilityChecker import HoeffdingCompatibility
from aria.automata.aalpy.learning_algs.stochastic_passive.FPTA import create_fpta
...
def run_JAlergia(path_to_data_file, automaton_type, path_to_jAlergia_jar, eps=0.05, heap_memory='-Xmx2048M'):
    ...
    import os
    import subprocess
    from aria.automata.aalpy.utils.FileHandler import load_automaton_from_file
