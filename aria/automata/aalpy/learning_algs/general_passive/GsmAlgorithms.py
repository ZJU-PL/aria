...
from aria.automata.aalpy import DeterministicAutomaton, Onfsm, NDMooreMachine
from aria.automata.aalpy.learning_algs.general_passive.GeneralizedStateMerging import run_GSM
from aria.automata.aalpy.learning_algs.general_passive.Instrumentation import ProgressReport
from aria.automata.aalpy.learning_algs.general_passive.GsmNode import GsmNode
from aria.automata.aalpy.learning_algs.general_passive.ScoreFunctionsGSM import ScoreCalculation, hoeffding_compatibility, \
    ScoreWithKTail
from aria.automata.aalpy.utils.HelperFunctions import dfa_from_moore
...
def run_Alergia_EDSM(data, automaton_type, eps=0.05, print_info=False):
    ...
    Returns:
        ...
        A Mc, Mdp or SMM
    """
    from aria.automata.aalpy.utils.HelperFunctions import mc_format_to_mdp, mc_from_mdp
