def get_Angluin_dfa():
    from aria.automata.aalpy.automata import Dfa
...
def get_faulty_coffee_machine_MDP():
    from aria.automata.aalpy.automata import Mdp, MdpState
...
def get_faulty_coffee_machine_SMM():
    from aria.automata.aalpy.automata import StochasticMealyMachine, StochasticMealyState
...
def get_balanced_string_sul(call_return_map, allow_empty_string):
    from aria.automata.aalpy.base import SUL
