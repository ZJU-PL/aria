...
from aria.automata.aalpy import Mdp, MarkovChain, McState, MooreMachine, Dfa, DfaState
...
def get_available_oracles_and_err_msg():
    ...
    from aria.automata.aalpy.oracles import RandomWordEqOracle
...
def make_input_complete(automaton, missing_transition_go_to='self_loop'):
    ...
    """
    from aria.automata.aalpy.base import DeterministicAutomaton
    from aria.automata.aalpy.automata import Dfa, MooreState, MealyMachine, Mdp, StochasticMealyMachine, Onfsm, \
