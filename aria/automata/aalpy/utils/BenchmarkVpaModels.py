...
from aria.automata.aalpy.automata.Vpa import Vpa, VpaAlphabet
...
def gen_arithmetic_data(num_sequences=3000, min_seq_len=2, max_seq_len=8):
    ...
    from aria.automata.aalpy.utils import convert_i_o_traces_for_RPNI
...
def get_all_VPAs():
    from aria.automata.aalpy import load_automaton_from_file
