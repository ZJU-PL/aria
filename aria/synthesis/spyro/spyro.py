...
def main():
    ...
    parser.add_argument(
        "--write-log", dest="write_log", action="store_true", default=False
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--inline-bnd", dest="inline_bnd", type=int, nargs="?", default=5
    )
    parser.add_argument(
        "--num-atom-max", dest="num_atom_max", type=int, nargs="?", default=3
    )
    parser.add_argument(
        "--disable-min", dest="disable_min", action="store_true", default=False
    )
    parser.add_argument(
        "--keep-neg-may", dest="keep_neg_may", action="store_true", default=False
    )
