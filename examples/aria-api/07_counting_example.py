...
from aria.counting.arith_counting_latte import count_lia_models
from aria.allsmt.bool_enumeration import count_models
...
def bool_count():
    ...
    try:
        print(
            f"Bool count: {count_z3_solutions(f)}, Enum: {count_z3_models_by_enumeration(f)}"
        )
    except:
        print("Boolean counting failed")
