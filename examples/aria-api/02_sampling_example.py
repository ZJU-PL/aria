...
def lra_sampling():
    ...
    for m in [
        ...
        SamplingMethod.REGION,
        SamplingMethod.DIKIN_WALK,
    ]:
        try:
...
def lia_sampling():
    ...
    opts = SamplingOptions(
        method=SamplingMethod.ENUMERATION, num_samples=5, random_seed=42
    )
...
def custom_sampler():
    ...
    try:
        ...
        opts = SamplingOptions(
            method=SamplingMethod.ENUMERATION, num_samples=5, random_seed=123
        )
        r = s.sample(opts)
