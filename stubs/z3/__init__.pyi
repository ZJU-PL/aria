...
class IntNumRef(Const, ArithRef):
    ...
    def __mul__(self, other: Union[int, IntNumRef]) -> ArithRef: ...
...
class ModelRef(Z3PPObject):
    ...
    def sexpr(self) -> str: ...
    def __getitem__(self, t: Union[AnyExprRef, FuncDeclRef]) -> AnyExprRef: ...
...
class Solver:
    ...
    def add(self, arg: Union[BoolRef, ExprRef]) -> None: ...
...
def Bools(names: str, ctx: Context = ...) -> List[BoolRef]: ...
def BoolVal(val: bool, ctx: Context = ...) -> BoolRef: ...
def Real(name: str, ctx: Context = ...) -> ArithRef: ...
def Reals(names: str, ctx: Context = ...) -> List[ArithRef]: ...
...
def And(*args: Union[BoolRef, ExprRef]) -> BoolRef: ...
@overload
def Or(*args: BoolRef) -> BoolRef: ...
@overload
def Or(args: List[BoolRef]) -> BoolRef: ...
def Or(*args: Union[BoolRef, List[BoolRef]]) -> BoolRef: ...
...
@overload
def substitute(t: AnyExprRef, m: List[Tuple[ExprRef, ExprRef]]) -> AnyExprRef: ...
def substitute(t: AnyExprRef, *m: Union[Tuple[ExprRef, ExprRef], List[Tuple[ExprRef, ExprRef]]]) -> AnyExprRef: ...
