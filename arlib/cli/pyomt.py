...
from arlib.optimization.omt_solver import solve_opt_file
...
def solve_omt_problem(filename: str, engine: str, solver_name: str, theory: str = None):
    ...
    if theory == "arith":
        ...
        from arlib.optimization.omtarith.arith_opt_qsmt import arith_opt_with_qsmt
        from arlib.optimization.omtarith.arith_opt_ls import arith_opt_with_ls
